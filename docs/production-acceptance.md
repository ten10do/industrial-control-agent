...
> 本文记录的是 2026-07-24、commit `41f6fed` 的历史线上验收。当前工作区新增的 readiness、输出边界、优化界面、方案持久化、OIDC 身份认证、RBAC、四眼审批、HMAC 审计链、事务 Outbox、PostgreSQL/Alembic 数据层、幂等写入、乐观并发、原子受控导出、Redis 全局配额及可恢复模型任务尚未部署验收，不应将本记录视为这些新功能的线上结论。
